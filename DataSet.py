    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'train':
            ...
            for i in indexes:
                ...
                print (np.asarray(transforms_image).shape)
                cv2.imwrite('transforms_image.png', np.asarray(transforms_image))
                cv2.imwrite('tranasforms_densepose.png', np.asarray(transforms_densepose))
